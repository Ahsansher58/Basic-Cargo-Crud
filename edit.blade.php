<form class="row g-3 auto-width" action="{{ route('cargo-types.update', $type->id)}}" method="post" enctype='multipart/form-data'>
    @csrf
    @method('patch')
    <div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="priority" name="priority" aria-describedby="inputGroupPrepend" required value="{{$type->priority}}">
